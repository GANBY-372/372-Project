...
class PickupTest {
    ...
    @Test
    void getType() {
        Pickup pickup = new Pickup("V002", "F-150", "Ford", 25000.00, "001", LocalDateTime.now(), false);
        assertEquals("Pickup", pickup.getType(), "The type should be 'Pickup'");
    }

    @Test
    void testEquals() {
        Pickup pickup1 = new Pickup("V002", "F-150", "Ford", 25000.00, "001",  LocalDateTime.now(), false);
        Pickup pickup2 = new Pickup("V002", "F-150", "Ford", 25000.00, "001", LocalDateTime.now(),false);
        Pickup pickup3 = new Pickup("V003", "Ram 1500", "Dodge", 30000.00, "002", LocalDateTime.now(),false);
