...
public class SedanTest {
    ...
    @Test
    void getType() {
        Sedan sedan = new Sedan("V001", "Camry", "Toyota", 15000.00, "001", LocalDateTime.now());
    ...
    void testEquals() {
        ...
        Sedan sedan1 = new Sedan("V001", "Camry", "Toyota", 15000.00, "001", now);
        Sedan sedan2 = new Sedan("V001", "Accord", "Honda", 20000.00, "002", now);
        Sedan sedan3 = new Sedan("V002", "Corolla", "Toyota", 18000.00, "001", now);
