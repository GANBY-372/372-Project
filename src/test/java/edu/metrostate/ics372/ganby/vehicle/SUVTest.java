...
class SUVTest {
    ...
    @Test
    void getType() {
        SUV suv = new SUV("V005", "Highlander", "Toyota", 35000.00, "003", LocalDateTime.now());
    ...
    void testEquals() {
        ...
        SUV suv1 = new SUV("V005", "Highlander", "Toyota", 35000.00, "003", now);
        SUV suv2 = new SUV("V005", "CR-V", "Honda", 32000.00, "004", now);
        SUV suv3 = new SUV("V006", "Escape", "Ford", 28000.00, "005", now);
    ...
    void testToString() {
        LocalDateTime now = LocalDateTime.now();
        SUV suv = new SUV("V005", "Highlander", "Toyota", 35000.00, "003", now);
