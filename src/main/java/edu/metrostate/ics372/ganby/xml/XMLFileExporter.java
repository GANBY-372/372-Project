...
public class XMLFileExporter {
    ...
    public void exportToFile(Dealer dealer, String filePath) {
        try {
            ...
            dealerElement.setAttribute("id", dealer.getDealerId());
            dealersElement.appendChild(dealerElement);

            // Dealer name
            Element nameElement = doc.createElement("Name");
            nameElement.appendChild(doc.createTextNode(dealer.getDealerName()));
            ...
            for (Vehicle vehicle : dealer.getVehicleCollection().values()) {
                ...
                vehicleElement.setAttribute("type", VehicleCategory.getVehicleType(vehicle));
