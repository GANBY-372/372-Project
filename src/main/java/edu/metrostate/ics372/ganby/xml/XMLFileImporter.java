...
public class XMLFileImporter {
    ...
    private Vehicle createVehicle(Element vehicleElement, String dealerId) throws IllegalAccessException {
        ...
        Vehicle vehicle;
        switch (category) {
            case SUV -> vehicle = new vehicle.SUV(id, model, manufacturer, price, dealerId, acquisitionDate);
            case SEDAN -> vehicle = new vehicle.Sedan(id, model, manufacturer, price, dealerId, acquisitionDate);
            case PICKUP -> vehicle = new vehicle.Pickup(id, model, manufacturer, price, dealerId, acquisitionDate);
            case SPORTS_CAR -> vehicle = new vehicle.SportsCar(id, model, manufacturer, price, dealerId, acquisitionDate);
            default -> {
